export const METADATA = {
  title: "Portfolio | Zoheb Mamoo",
  description:
    "I bridge the gap between design and development. I take responsibility to craft an aesthetic user experience using modern frontend architecture.",
  siteUrl: "https://notreallyzoh.com/",
};
...
export const EMAIL = "notreallyzoh@gmail.com";

export const SOCIAL_LINKS = {
  linkedin: "https://www.linkedin.com/in/zoheb-mamoo/",
  github: "https://github.com/notreallyzoh",
  instagram: "https://www.instagram.com/notreallyzoh/",
};
...
export const PROJECTS: IProject[] = [
  {
    name: "Quizzify - AI Quiz Generator",
    image: "/projects/quizzify.jpg",
    blurImage: "/projects/blur/quizzify-blur.jpg",
    description: "Simple and Efficient Quiz maker and Analytics tool for businesses, educators, or community organizers. Designed in Figma, Build with MERN Stack and OpenAI Api",
    gradient: ["#1F6582", "#1ABCFE"],
    url: "https://quizzify-pesto.netlify.app/",
  ...
  },
  {
    ...
    description: "Marketing site for Food Distribution Agency",
    gradient: ["#153BB9", "#0E2C8B"],
    url: "https://www.huminos.com/",
    tech: ["react", "next", "gsap", "tailwind"],
  },
  {
    name: "Earthgrime Portfolio Website",
    image: "/projects/dlt-website.jpg",
    blurImage: "/projects/blur/dlt-website-blur.jpg",
    description: "Portfolio website of a hiphop artist based in India",
    gradient: ["#245B57", "#004741"],
    url: "https://www.earthgrime.com/",
